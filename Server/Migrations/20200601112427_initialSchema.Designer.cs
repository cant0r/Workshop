...
namespace Server.Migrations
{
    ...
    [Migration("20200601112427_initialSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.Auto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Server.Models.JobLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Server.Models.JobTechnician", b =>
                {
                    b.Property<long>("JobId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Server.Models.Job", b =>
                {
                    b.HasOne("Server.Models.Auto", "Auto")
                        .WithMany()
                        .HasForeignKey("AutoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Server.Models.Manager", "JobManager")
                        .WithMany()
                        .HasForeignKey("JobManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Server.Models.State", "WorkState")
                        .WithMany()
            ...
            modelBuilder.Entity("Server.Models.JobTechnician", b =>
                {
                    ...
                    b.HasOne("Server.Models.Technician", "Technician")
                        .WithMany("JobTechnicians")
